...
const Header: React.FC = () => {
  ...
  return (
    <header className="sticky top-0 z-20 bg-white flex items-center justify-between h-14 px-4 md:px-6 border-b border-youtube-border">
      {/* Left section */}
      ...
      <div className="hidden sm:flex flex-1 max-w-2xl mx-4 md:mx-10">
        <div className="flex w-full">
          <div className="relative flex-1">
            <Input
              type="search"
              placeholder="Search"
              className="w-full pr-10 rounded-r-none border border-r-0 border-gray-300 focus-visible:ring-0 focus-visible:ring-offset-0"
              value={searchQuery}
              onChange={(e) => setSearchQuery(e.target.value)}
            />
          </div>
          <Button 
            className="bg-gray-100 hover:bg-gray-200 text-black rounded-l-none border border-l-0 border-gray-300"
            aria-label="Search"
          >
          ...
          <Button 
            variant="ghost" 
            size="icon" 
            className="ml-2 bg-gray-100 hover:bg-gray-200 rounded-full"
